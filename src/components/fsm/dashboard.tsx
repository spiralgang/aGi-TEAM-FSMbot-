    ...
    >
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          ...
          <p>
            FSMs provide the deterministic backbone for this model. Each state represents a compliance checkpoint. By chaining these states, we create a Supermax agent—a system that self-audits, enforces rules across all subsystems (builds, dependencies, policies), and maintains a verifiable record of its discipline.
          </p>
        </CardContent>
      </Card>
    </FsmViewWrapper>
